...
class Overall_Look:
    def __init__(self, master):
        ...
        self.master.configure(background = my_color) #the color will be changed later
...
##define style in ttk##
        ...
        self.style.configure('Header.TLabel', background = my_color, font = ('Arial', 24, 'bold'))
...
##this is the top frame, we will write a few sentences about this program##
        ...
        Button(self.bottom_frame, text = 'Manually Select Functional Groups', relief = RAISED,
                    command = self.hand_pick, font = ('Arial', 20, "bold")).grid(row = 0, column = 0, columnspan = 3, padx = 5, pady = 5)
        Button(self.bottom_frame, text = 'Auto-Detect Groups via SMILES', relief = RAISED,
                    command = self.smiles, font = ('Arial', 20, "bold")).grid(row = 0, column = 3, columnspan = 3, padx = 5, pady = 5)
...
class Auto_Search:
    ...
    def __init__(self, master):
        ...
        self.master.resizable(False, False)
        self.master.configure(background = my_color) # light blue
        ...
        ttk.Label(self.master, text = "Please input your molecule by typing its SMILES in the entry box.\n"
                                     ...
                                     , font = ('Arial', 16, 'bold'), justify = CENTER).pack(side  = TOP)
        
        self.top_frame = ttk.Frame(self.master, padding = (30, 15))
        self.top_frame.pack()      
        ##labels
        ttk.Label(self.top_frame, text = "Input your SMILES", justify = CENTER, font = ('Arial', 16, 'bold')).pack()
        ##entry box
        
        self.SMILES = StringVar()
        self.SMILES.set("CC1=CC(=C(C=C1)C(=O)O)O")
        ttk.Entry(self.top_frame, width = 70, font = ('Arial', 14), textvariable = self.SMILES).pack()
...
#add a Boiling Point to it.
        ...
        ttk.Label(self.middle_frame, text = "Temperature (K)", justify = CENTER,
                  font = ('Arial', 14, 'bold')).grid(row=11, column = 0, columnspan = 2, padx = 5, sticky = "sw")

        ttk.Entry(self.middle_frame, width = 8, font = ('Arial', 12),
        ...
        ttk.Label(self.middle_frame, text = "Boiling Point (K)", justify = CENTER,
                  font = ('Arial', 14, 'bold')).grid(row=12, column = 0, columnspan = 2, padx = 5, sticky = "sw")
...
####Labels at bottom for printing out results###
        self.L1a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L1a.pack()
        self.L2a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L2a.pack()
        self.L3a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L3a.pack()
        self.L4a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L4a.pack()
        self.L5a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L5a.pack()
        self.L6a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L6a.pack()
        self.L7a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L7a.pack()
        self.L8a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L8a.pack()
        self.L9a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L9a.pack()
        self.L10a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L10a.pack()
        self.L11a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L11a.pack()
        self.L12a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L12a.pack()
        self.L12b = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L12b.pack()
        self.L13a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L13a.pack()
        self.L14a = ttk.Label(self.bottom_frame, text = "", font = ('Arial', 16, 'bold'), foreground="blue")
        self.L14a.pack()
    ...
    def compute_single_mode(self, string):
        ...
        smarts = ["[CH3;A;X4;!R]","[CH2;A;X4;!R]","[CH1;A;X4;!R]","[CH0;A;X4;!R]","[CH2;A;X3;!R]",
                      ...
                      "[F]","[Cl]","[Br]", "[I]",
                      "[$([OH1]A)]","[O;H1;$(O-!@c)]","[OH0;X2;!R]","[#8H0;X2;R]", "[CH0;A;X3;!R]=O","[CH0;A;X3;R]=O",
...
class Hand_Pick:
    ...
    def __init__(self, master):
        ...
        self.style.configure('TLabel', background = '#add8e6', font = ('Arial', 15))
        self.style.configure('Header.TLabel', font = ('Arial', 24, 'bold'))
        ...
        self.top_frame.pack()
        ##labels
        ttk.Label(self.top_frame, text = "Non-ring increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
                                            column = 0, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Ring increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
                                            column = 2, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Halogen increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
                                            column = 4, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Oxygen increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
                                            column = 6, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Nitrogen increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
                                            column = 8, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Sulfur increments", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row = 0,
...
#add a Boiling Point to it.
        ...
        ttk.Label(self.top_frame, text = "Temperature (K)", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=12, column = 0, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Number of Atoms", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=12, column = 4, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Molecule Weight (g/mol)", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=12, column = 8, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Number of Carbon Atoms", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=13, column = 0, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Number of Hetero Atoms", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=13, column = 4, columnspan = 2, padx = 5, sticky = "sw")
        ttk.Label(self.top_frame, text = "Boiling Point (K)", justify = CENTER, font = ('Arial', 15, 'bold')).grid(row=14, column = 0, columnspan = 2, padx = 5, sticky = "sw")

        ttk.Entry(self.top_frame, width = 12, font = ('Arial', 13),
        ...
        self.entry_N_1 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_0)
        self.entry_N_2 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_1)
        self.entry_N_3 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_2)
        self.entry_N_4 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_3)
        self.entry_N_5 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_4)
        self.entry_N_6 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_5)
        self.entry_N_7 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_6)
        self.entry_N_8 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_7)
        self.entry_N_9 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_8)
        self.entry_N_10 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_9)
        self.entry_N_11 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_10)
        self.entry_N_12 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_11)
        self.entry_N_13 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_12)
        self.entry_N_14 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_13)
        self.entry_N_15 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_14)
        self.entry_N_16 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_15)
        self.entry_N_17 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_16)
        self.entry_N_18 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_17)
        self.entry_N_19 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_18)
        self.entry_N_20 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_19)
        self.entry_N_21 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_20)
        self.entry_N_22 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_21)
        self.entry_N_23 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_22)
        self.entry_N_24 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_23)
        self.entry_N_25 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_24)
        self.entry_N_26 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_25)
        self.entry_N_27 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_26)
        self.entry_N_28 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_27)
        self.entry_N_29 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_28)
        self.entry_N_30 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_29)
        self.entry_N_31 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_30)
        self.entry_N_32 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_31)
        self.entry_N_33 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_32)
        self.entry_N_34 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_33)
        self.entry_N_35 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_34)
        self.entry_N_36 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_35)
        self.entry_N_37 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_36)
        self.entry_N_38 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_37)
        self.entry_N_39 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_38)
        self.entry_N_40 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_39)
        self.entry_N_41 = ttk.Entry(self.top_frame, width = self.width, font = ('Arial', 13), textvariable = self.N_40)
